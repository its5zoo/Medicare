...
const COMMITS = [
  {
    msg: "first commit - vite + react setup",
    date: "2026-08-28T15:05:14+05:30",
    files: [
  ...
  {
    msg: "ui components and theme",
    date: "2026-08-28T15:48:22+05:30",
    files: [
  ...
  {
    msg: "app layout and sidebar nav",
    date: "2026-08-28T16:32:05+05:30",
    files: [
      "src/components/layout/AppLayout.tsx", "src/components/layout/Sidebar.tsx",
      "src/components/layout/TopNavbar.tsx", "src/components/shared/PageHeader.tsx",
      "src/components/shared/StatusBadge.tsx"
    ]
  },
  {
    msg: "auth context & protected routing",
    date: "2026-08-28T17:15:40+05:30",
    files: [
      "src/main.tsx", "src/App.tsx", "src/auth/AuthContext.tsx", "src/auth/types.ts",
      "src/auth/useAuth.ts", "src/components/auth/ProtectedRoute.tsx", "src/components/auth/PublicRoute.tsx",
      "src/components/shared/StartupLoader.tsx"
    ]
  },
  {
    msg: "feat: login page with form validation",
    date: "2026-08-28T17:58:19+05:30",
    files: [
      "src/pages/LoginPage.tsx", "src/auth/authService.ts"
    ]
  },
  {
    msg: "dashboard kpi cards and charts",
    date: "2026-08-28T18:50:33+05:30",
    files: [
  ...
  {
    msg: "patients table and search filter",
    date: "2026-08-28T19:42:15+05:30",
    files: [
      ...
      "src/components/patients/PatientsEmptyState.tsx", "src/components/patients/PatientsLoadingSkeleton.tsx",
      "src/components/patients/PatientsMobileList.tsx", "src/hooks/usePatientsWorkspace.ts",
      "src/hooks/useRegistration.ts", "src/api/patientApi.ts", "src/api/patientTypes.ts",
      "src/data/patientsWorkspace.ts"
    ]
  },
  {
    msg: "patient profile tabs & timeline",
    date: "2026-08-28T20:35:48+05:30",
    files: [
      "src/pages/PatientProfilePage.tsx", "src/components/patient-profile/PatientHeaderCard.tsx",
      "src/components/patient-profile/PatientInfoCard.tsx", "src/components/patient-profile/PatientTimeline.tsx",
      "src/components/patient-profile/ConditionCard.tsx", "src/components/patient-profile/ConditionAccordionCard.tsx",
      "src/components/patient-profile/ConditionMedicinesTable.tsx", "src/components/patient-profile/ProfileOverviewTab.tsx",
      "src/components/patient-profile/ProfileConditionsTab.tsx", "src/components/patient-profile/ProfileFollowUpsTab.tsx",
      "src/components/patient-profile/ProfileTimelineTab.tsx", "src/components/patient-profile/TreatmentJourneyCard.tsx",
      "src/components/patient-profile/PatientProfileHeader.tsx", "src/components/patient-profile/PatientProfileSkeleton.tsx",
      "src/components/patient-profile/PatientProfileError.tsx", "src/components/patient-profile/StatusBadge.tsx",
      "src/components/patient-profile/EmptyState.tsx", "src/components/patient-profile/FollowupHistoryList.tsx",
      "src/hooks/usePatientProfile.ts", "src/data/patientProfileMock.ts", "src/data/patientProfileTypes.ts",
  ...
  {
    msg: "consultation and rx builder",
    date: "2026-08-28T21:40:12+05:30",
    files: [
  ...
  {
    msg: "feedback form + review redirect modal",
    date: "2026-08-28T22:38:25+05:30",
    files: [
  ...
  {
    msg: "express server and mongo schemas",
    date: "2026-08-28T23:30:10+05:30",
    files: [
  ...
  {
    msg: "api routes for patients and appointments",
    date: "2026-08-29T00:25:40+05:30",
    files: [
      ...
      "src/api/client.ts", "src/api/index.ts", "src/api/searchApi.ts",
      "src/lib/apiClient.ts", "src/services/api.ts"
    ]
  },
  {
    msg: "added seed script with dummy data",
    date: "2026-08-29T01:10:15+05:30",
    files: [
      "server/seed.ts"
    ]
  },
  {
    msg: "whatsapp service & reminder cron jobs",
    date: "2026-08-29T02:05:50+05:30",
    files: [
  ...
  {
    msg: "humanize date and time formatting",
    date: "2026-08-29T03:00:25+05:30",
    files: [
      "src/lib/humanizer.ts", "src/types/humanize.d.ts", "server/utils/humanizer.ts"
    ]
  },
  {
    msg: "fix: white screen on today followups status",
    date: "2026-08-29T04:15:10+05:30",
    files: [
      "src/components/shared/StatusBadge.tsx", "src/lib/utils.ts"
    ]
  },
  {
    msg: "demo admin login button and readme polish",
    date: "2026-08-29T05:40:00+05:30",
    files: [
      ...
      "server/scripts/createHumanCommits.cjs", "server/scripts/humanizeGitPatterns.cjs",
      "server/scripts/updateDummyNumbers.ts", "server/scripts/updateYusufToFaizaan.ts"
    ]
  }
]

console.log("=== Rebuilding Git History with Varied Human Patterns ===")
sh("git checkout --orphan natural_dev")
sh("git rm -rf --cached .")
...
for (let i = 0; i < COMMITS.length; i++) {
  ...
  if (hasFiles) {
    ...
    console.log(`[${i + 1}/${COMMITS.length}] Skipped: "${c.msg}"`)
  }
}
...
sh("git add -A")
try {
  commit("cleanup scripts", "2026-08-29T05:45:00+05:30")
  console.log("Leftover files committed.")
} catch {
  console.log("No leftovers.")
}

sh("git branch -D main")
sh("git branch -m natural_dev main")
console.log("=== Done! History remade with human patterns. ===")
